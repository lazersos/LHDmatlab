function [time, P] = get_LHD_nbi5a(shotnum)
%   GET_LHD_nbi5a Returns the power of NBI source 4a. It uses the LHD webservice 
%   https://exp.lhd.nifs.ac.jp/opendata/LHD/ for accessing the data.
%
%   Example
%       [time, P] = get_LHD_nbi5a(164423);
%
